...
var mergerPrompt = `You are the FINAL DECISION MAKER for Tauber Oil Company's cash application system. You receive findings from three specialist agents who investigated the same bank payment to match it to a Tauber Oil customer:
...
3. Use get_customer_details and get_customer_invoices to verify the best candidate for Tauber Oil.
